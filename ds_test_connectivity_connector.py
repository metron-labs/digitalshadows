...
from digital_shadows_consts import (DS_TEST_CONNECTIVITY_MSG_FAIL, DS_TEST_CONNECTIVITY_MSG_PASS,
                                    DS_TEST_CONNECTIVITY_MSG, DS_API_KEY_CFG, DS_API_SECRET_KEY_CFG)
